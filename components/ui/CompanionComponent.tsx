...
const CompanionComponent = ({companionId,topic,subject,name,userName, userImage, style, voice}:CompanionComponentProps) => {
            ...
            <section className="flex gap-8 max-sm:flex-col">
                ...
                <div className="user-section">
                    ...
                    <button className="btn-mic" onClick={toggleMicrophone} disabled={callStatus!==CallStatus.ACTIVE}>
                        <Image src={isMuted?'/icons/mic-off.svg':'/icons/mic-on.svg'} alt={isMuted ? 'mute' : 'muted'} width={36} height={36}/>
